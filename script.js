...
const players = [
  ...
  { name: 'Michael Essien', role: 'CM', value: 55000000 }, // Retired
   { name: 'Neymar Jr', role: 'LW', value: 90000000 },
  { name: 'Sadio Mané', role: 'LW', value: 85000000 },
  { name: 'Kylian Mbappé', role: 'LW', value: 180000000 },
  { name: 'Raheem Sterling', role: 'LW', value: 70000000 },
  { name: 'Son Heung-min', role: 'LW', value: 95000000 },
  { name: 'Jack Grealish', role: 'LW', value: 75000000 },
  { name: 'Eden Hazard', role: 'LW', value: 80000000 },
  { name: 'Phil Foden', role: 'LW', value: 70000000 },
  { name: 'Ousmane Dembélé', role: 'LW', value: 70000000 },
  { name: 'Jadon Sancho', role: 'LW', value: 75000000 },
  { name: 'Nicolas Pépé', role: 'LW', value: 50000000 },
  { name: 'Christian Pulisic', role: 'LW', value: 45000000 },
  { name: 'Lucas Moura', role: 'LW', value: 55000000 },
  { name: 'Wilfried Zaha', role: 'LW', value: 60000000 },
  { name: 'Douglas Costa', role: 'LW', value: 50000000 },
  { name: 'Lorenzo Insigne', role: 'LW', value: 60000000 },
  { name: 'Marcus Rashford', role: 'LW', value: 85000000 },
  { name: 'Ángel Di María', role: 'LW', value: 70000000 },
  { name: 'Gerard Deulofeu', role: 'LW', value: 40000000 },
  { name: 'Isco', role: 'LW', value: 45000000 }, // Retired
  { name: 'David Silva', role: 'LW', value: 60000000 }, // Retired
  { name: 'Ryan Giggs', role: 'LW', value: 85000000 }, // Retired
  { name: 'Cristiano Ronaldo', role: 'LW', value: 85000000 }, // Retired
  { name: 'Ryan Fraser', role: 'LW', value: 25000000 },
  { name: 'Xherdan Shaqiri', role: 'LW', value: 40000000 },
  { name: 'Dries Mertens', role: 'LW', value: 50000000 },
  { name: 'Hatem Ben Arfa', role: 'LW', value: 25000000 }, // Retired
  { name: 'Juan Mata', role: 'LW', value: 35000000 }, // Retired
  { name: 'Antonio Valencia', role: 'LW', value: 25000000 }, // Retired
  { name: 'Benjamin Mendy', role: 'LW', value: 40000000 },
  { name: 'Emmanuel Adebayor', role: 'LW', value: 30000000 }, // Retired
  { name: 'Yannick Carrasco', role: 'LW', value: 60000000 },
  { name: 'Lucas Ocampos', role: 'LW', value: 50000000 },
  { name: 'Marcos Alonso', role: 'LW', value: 40000000 },
  { name: 'Vinícius Júnior', role: 'LW', value: 100000000 },
  { name: 'Zlatan Ibrahimović', role: 'LW', value: 70000000 }, // Retired
  { name: 'Maxwel Cornet', role: 'LW', value: 35000000 },
  { name: 'Cengiz Ünder', role: 'LW', value: 40000000 },
  { name: 'Gerard Moreno', role: 'LW', value: 45000000 },
  { name: 'Martin Ødegaard', role: 'LW', value: 50000000 },
  { name: 'Henrikh Mkhitaryan', role: 'LW', value: 40000000 },
  { name: 'Franck Ribéry', role: 'LW', value: 50000000 }, // Retired
  { name: 'Ricardo Quaresma', role: 'LW', value: 40000000 }, // Retired
  { name: 'Álvaro Morata', role: 'LW', value: 45000000 },
  { name: 'Raul Jiménez', role: 'LW', value: 35000000 },
  { name: 'Riyad Mahrez', role: 'LW', value: 65000000 },
  { name: 'Timo Werner', role: 'LW', value: 45000000 },
  { name: 'Gareth Bale', role: 'LW', value: 70000000 }, // Retired
  { name: 'Angel Correa', role: 'LW', value: 40000000 },
  { name: 'Ferran Torres', role: 'LW', value: 55000000 },
  { name: 'Mohamed Salah', role: 'LW', value: 120000000 },
  { name: 'Luca Pellegrini', role: 'LW', value: 35000000 },

  { name: 'Mohamed Salah', role: 'RW', value: 120000000 },
  { name: 'Jadon Sancho', role: 'RW', value: 75000000 },
  { name: 'Riyad Mahrez', role: 'RW', value: 65000000 },
  { name: 'Lionel Messi', role: 'RW', value: 100000000 }, // Retired
  { name: 'Raheem Sterling', role: 'RW', value: 70000000 },
  { name: 'Gerard Deulofeu', role: 'RW', value: 45000000 },
  { name: 'Hakim Ziyech', role: 'RW', value: 60000000 },
  { name: 'Angel Di María', role: 'RW', value: 70000000 },
  { name: 'Serge Gnabry', role: 'RW', value: 75000000 },
  { name: 'Ferran Torres', role: 'RW', value: 55000000 },
  { name: 'Douglas Costa', role: 'RW', value: 50000000 },
  { name: 'Willian', role: 'RW', value: 50000000 }, // Retired
  { name: 'Dani Carvajal', role: 'RW', value: 55000000 },
  { name: 'Nicolas Pépé', role: 'RW', value: 50000000 },
  { name: 'Juan Cuadrado', role: 'RW', value: 40000000 },
  { name: 'Dejan Kulusevski', role: 'RW', value: 55000000 },
  { name: 'Lucas Moura', role: 'RW', value: 50000000 },
  { name: 'Xherdan Shaqiri', role: 'RW', value: 40000000 },
  { name: 'André Schürrle', role: 'RW', value: 30000000 }, // Retired
  { name: 'Adama Traoré', role: 'RW', value: 50000000 },
  { name: 'Musa Barrow', role: 'RW', value: 35000000 },
  { name: 'Maxwel Cornet', role: 'RW', value: 40000000 },
  { name: 'Isco', role: 'RW', value: 45000000 }, // Retired
  { name: 'Bryan Gil', role: 'RW', value: 35000000 },
  { name: 'Emil Forsberg', role: 'RW', value: 45000000 },
  { name: 'Martin Ødegaard', role: 'RW', value: 50000000 },
  { name: 'Ivan Perišić', role: 'RW', value: 40000000 },
  { name: 'Mason Greenwood', role: 'RW', value: 40000000 },
  { name: 'Phil Foden', role: 'RW', value: 70000000 },
  { name: 'Eden Hazard', role: 'RW', value: 80000000 }, // Retired
  { name: 'Brahim Díaz', role: 'RW', value: 40000000 },
  { name: 'Nani', role: 'RW', value: 30000000 }, // Retired
  { name: 'David Neres', role: 'RW', value: 45000000 },
  { name: 'David Beckham', role: 'RW', value: 75000000 }, // Retired
  { name: 'Timo Werner', role: 'RW', value: 45000000 },
  { name: 'Rafael Leão', role: 'RW', value: 60000000 },
  { name: 'Suso', role: 'RW', value: 35000000 },
  { name: 'Henrikh Mkhitaryan', role: 'RW', value: 40000000 },
  { name: 'Rachid Ghezzal', role: 'RW', value: 40000000 },
  { name: 'Lorenzo Insigne', role: 'RW', value: 60000000 },
  { name: 'Francesco Caputo', role: 'RW', value: 30000000 },
  { name: 'Pablo Sarabia', role: 'RW', value: 35000000 },
  { name: 'Moussa Diaby', role: 'RW', value: 60000000 },
  { name: 'Lukas Nmecha', role: 'RW', value: 40000000 },
  { name: 'José Luis Gayà', role: 'RW', value: 40000000 },
  { name: 'Luca Pellegrini', role: 'RW', value: 35000000 },
  { name: 'Bryan Mbeumo', role: 'RW', value: 45000000 },
  { name: 'Josip Iličić', role: 'RW', value: 50000000 },
  { name: 'Rodrigo Bentancur', role: 'RW', value: 35000000 },
  { name: 'Marcus Rashford', role: 'RW', value: 85000000 },

  { name: 'Ayoze Pérez', role: 'RW', value: 30000000 },
  { name: 'Ismaïla Sarr', role: 'RW', value: 35000000 },
  { name: 'Cengiz Ünder', role: 'RW', value: 40000000 },
  { name: 'Andreas Schürrle', role: 'RW', value: 30000000 }, // Retired
  { name: 'Alex Oxlade-Chamberlain', role: 'RW', value: 45000000 },
  { name: 'Juan Mata', role: 'RW', value: 40000000 }, // Retired
  { name: 'Antonio Valencia', role: 'RW', value: 40000000 }, // Retired
  { name: 'Benjamin Bourigeaud', role: 'RW', value: 35000000 },
  { name: 'Anwar El Ghazi', role: 'RW', value: 35000000 },
  { name: 'David Beckham', role: 'RW', value: 70000000 }, // Retired
  { name: 'Vincenzo Grifo', role: 'RW', value: 35000000 },
  { name: 'Youssef En-Nesyri', role: 'RW', value: 40000000 },
  { name: 'Leandro Trossard', role: 'RW', value: 45000000 },
  { name: 'Josip Brekalo', role: 'RW', value: 35000000 },
  { name: 'Nico Williams', role: 'RW', value: 40000000 },
  { name: 'Algeria’s Said Benrahma', role: 'RW', value: 40000000 },
  { name: 'Edin Višća', role: 'RW', value: 30000000 },
  { name: 'Keita Baldé', role: 'RW', value: 35000000 },
  { name: 'Victor Moses', role: 'RW', value: 30000000 },
  { name: 'Nabil Fekir', role: 'RW', value: 55000000 },
  { name: 'Mame Biram Diouf', role: 'RW', value: 25000000 },
  { name: 'Junior Sambia', role: 'RW', value: 35000000 },
  { name: 'Hatem Ben Arfa', role: 'RW', value: 35000000 },
  { name: 'Eden Hazard', role: 'RW', value: 80000000 }, // Retired
  { name: 'Félix Gutiérrez', role: 'RW', value: 30000000 },
  { name: 'Moses Simon', role: 'RW', value: 40000000 },
  { name: 'Samu Castillejo', role: 'RW', value: 35000000 },
  { name: 'Jérémy Doku', role: 'RW', value: 50000000 },
  { name: 'Jérémy Ménez', role: 'RW', value: 40000000 },
  { name: 'Andreas Pereira', role: 'RW', value: 40000000 },
  { name: 'Shoya Nakajima', role: 'RW', value: 35000000 },
  { name: 'Matheus Pereira', role: 'RW', value: 40000000 },
  { name: 'Mario Götze', role: 'RW', value: 45000000 }, // Retired
  { name: 'Marco Reus', role: 'RW', value: 65000000 },
  { name: 'Kenedy', role: 'RW', value: 35000000 },
  { name: 'Nani', role: 'RW', value: 30000000 }, // Retired
  { name: 'Donyell Malen', role: 'RW', value: 50000000 },
  { name: 'Rafael Leão', role: 'RW', value: 60000000 },
  { name: 'Diego Laínez', role: 'RW', value: 35000000 },
  { name: 'Takumi Minamino', role: 'RW', value: 45000000 },
  { name: 'Romain Alessandrini', role: 'RW', value: 30000000 },
  { name: 'Yassine Bounou', role: 'RW', value: 35000000 },
  { name: 'Sofiane Boufal', role: 'RW', value: 40000000 },
